...
class Rig(BaseRig):
    ...
    def generate_widgets(self):
        ...
        csm_text = bone.name if '@name' in params.custom_text else params.custom_text

        # Create control widget:
        text_wgt = createTextWidget(txt=csm_text, rig=self.obj, bone_name=bones.ctrl.master, bone_transform_name=None)
